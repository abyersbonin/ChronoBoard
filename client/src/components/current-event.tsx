...
export function CurrentEvent({ event }: CurrentEventProps) {
  ...
  if (!event) {
    return (
      <div className="backdrop-blur-sm rounded-xl p-6 border mb-8" style={{ 
        backgroundColor: 'rgba(54, 69, 92, 0.25)', 
        borderColor: 'rgba(214, 204, 194, 0.3)' 
      }}>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-semibold text-white">À présent</h2>
          <div className="text-3xl font-bold text-blue-300">{getCurrentTime()}</div>
        </div>
